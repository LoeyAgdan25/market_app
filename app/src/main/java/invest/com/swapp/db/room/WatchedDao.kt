...
interface WatchedDao {
    @Query("SELECT stocks_watched_table.buy_price, stocks_watched_table.sell_price, stocks_watched_table.symbol,stocks_table.symbol, stocks_table.price, stocks_table.percent_change  FROM stocks_watched_table INNER JOIN stocks_table ON stocks_watched_table.symbol = stocks_table.symbol")
